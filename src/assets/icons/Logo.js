...
function Logo({ size = '1em', ...rest }) {
  return (
    <SvgIcon sx={{ width: size, height: size }} {...rest}>
      <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2931 2931" width="24" height="24">
        <path
          fill="white"
