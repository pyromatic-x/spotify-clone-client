...
const Track = memo(function Track({ track }: any) {
  ...
  return (
    <StyledTrackCard onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)}>
      <Grid container direction="row" flexWrap="nowrap" alignItems="center" position="relative">
        <Avatar
          variant="rounded"
          src={track.image}
          alt={track.name}
