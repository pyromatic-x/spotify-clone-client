...
export const homeSections: Array<ISection> = [
  {
    ...
    items: [
      {
        image: {
          src: 'https://i1.sndcdn.com/avatars-7QO5WHHCGzYvDpRc-X8U87g-t500x500.jpg',
          type: 'square',
          style: 'curves',
        },
        title: 'Daily Mix 2',
      ...
      {
        image: {
          src: 'https://yt3.googleusercontent.com/1Irc67lGWwWZRUwMzTyXTH5XjsQBePeW5-JgAR4hdX-Ro_QuUepWekqyrCchgKScW1n9g-5_GNo=s900-c-k-c0x00ffffff-no-rj',
          type: 'square',
          style: 'curves',
        },
        title: 'Daily Mix 5',
