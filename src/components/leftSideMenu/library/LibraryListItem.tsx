...
const hoverStyles = (bgColor: string) => {
  return {
    "&": {
      borderRadius: "6px",
      cursor: "pointer",
...
const LibraryListItem = memo(
  ({ author, title, subTitle, image, type, leftMenuCollapsed, showDescription }: IProps) => {
    const secondaryText = showDescription ? author : capitalizeFirstLetter(type.slice(0, -1));
